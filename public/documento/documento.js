...
const listaUsuariosConectado = document.getElementById("usuarios-conectados");
...
function atualizarInterfaceUsuarios(usuariosNoDocumentos) {
  listaUsuariosConectado.innerHTML = "";

  usuariosNoDocumentos.forEach((usuario) => {
    listaUsuariosConectado.innerHTML += `
